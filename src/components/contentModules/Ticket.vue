    ...
    <div class="ticket-body">
      <div class="ticket-title">
        <select v-model="ticketValues.operation" name="operation-type">
          <option v-for="operation in operationTypes" :key="operation">{{ operation }}</option>
        </select>
      ...
      <div class="ticket-data">
        <div class="ticket-documents-block" v-show="btnDocs.marker">
          ...
          <div class="docs-area-block">
            <textarea name="docs-textarea" v-model.lazy="arrayOfDocuments" class="textarea"></textarea>
          </div>
        </div>
      ...
      <div class="ticket-buttons">
        <div class="btn-group">
          <div class="ticket-btn-docs btn" @click="btnSaveDocs">{{ btnDocs.value[btnDocs.marker] }}</div>
        </div>
