        ...
        <form class="form">
          <div class="input-wrapper">
            <span class="input-icon">
              <img src="@/components/assets/avatar.svg" alt="login" />
            </span>
            <input
              id="login"
              class="input-block"
          ...
          <div class="input-wrapper">
            <span class="input-icon">
              <img src="@/components/assets/lock.svg" alt="pass" />
            </span>
            <input
              id="password"
              class="input-block"
            ...
            <span class="input-icon visible" @click="pass_eye = !pass_eye" v-if="password">
              <img
                ...
                key="1"
              />
              <img src="@/components/assets/hide.svg" alt="!" class="visible" v-else key="2" />
            </span>
          </div>
        </form>
        <div class="btn-group">
          <button class="btn btn-info" @click.prevent="toAuth">Войти</button>
          <button class="btn btn-submit" @click.prevent="retisterRequest">Зарегистрироваться</button>
        </div>
      </div>
    </div>
  </div>
